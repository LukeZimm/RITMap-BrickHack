...
function Map() {
    ...
    const [formcategory, setFormcategory] = useState('review');
                                ...
                                <div className="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl dark:bg-gray-900 sm:my-8 sm:w-full sm:max-w-sm sm:p-6 sm:align-middle">
                                    ...
                                    <form className="mt-4" action="#">
                                        ...
                                        <label className="block mt-3" for="text">
                                            <input type="text" onChange={e => setFormTitle(e.target.value)} name="title" id="email" placeholder="Title" className="block w-full px-4 py-3 text-sm text-gray-700 bg-white border border-gray-200 rounded-md focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300" />
                                        </label>

                                        <label className="block mt-3" for="text">
                                            <input type="text" onChange={e => setFormText(e.target.value)} name="body" id="email" placeholder="Text" className="block w-full px-4 py-3 text-sm text-gray-700 bg-white border border-gray-200 rounded-md focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300" />
                                        </label>

                                        <select id="category" onChange={e => setFormcategory(e.target.value)} className="mt-3 bg-gray-50 border text-gray-800 capitalize dark:text-whitetext-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-700 dark:ng-gray-700 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
